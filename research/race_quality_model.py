...
from research.sire_factor_aptitude import ANCESTOR_SLOTS, DEFAULT_WEIGHTS, _compute_aptitude_fast
...
PRIORS_JSON_PATH = Path(__file__).resolve().parent.parent / "data" / "research" / "race_quality_priors.json"
...
def get_race_quality_meta() -> dict[str, Any]:
    ...
    return {
        ...
        "tuning_hint_ja": (
            "セグメント別のデータ駆動補正: "
            "python -m research.tune_race_quality_priors を実行すると "
