...
例::
    ...
    SCRAPE_QUEUE_PARALLEL=1 python3 -m research.trial_horse_training_queue_10
"""
...
from pipeline.horse_entity_layout import horse_shard4  # noqa: E402
...
def main() -> int:
    ...
    from scraper.horse_training_local import horse_training_local_root
