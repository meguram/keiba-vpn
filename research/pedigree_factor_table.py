...
Usage::
  ...
  python3 -m research.pedigree_factor_table --out data/modeling/horse_pedigree_factors.parquet

  # 種牡馬因子 JSON を明示
  python3 -m research.pedigree_factor_table --stats data/research/sire_factor_stats.json
"""
...
def run_build(
    *,
    ...
    from research.sire_factor_stats import load_sire_factor_stats
