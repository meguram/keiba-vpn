...
CLI::
    python3 -m research.pedigree_stage5_3_eval --max-rows 100000 --run-prereqs
"""
...
from pipeline.track_bias_pedigree import stage_key  # noqa: E402
from research.build_maternal_stallion_stage_stats import (  # noqa: E402
...
from research.pedigree_stage5_3_features import (  # noqa: E402
    StageStatsStore,
    build_feature_row,
    build_graph_bundle,
    louvain_like_labels,
...
def main() -> None:
    ...
    if args.run_prereqs:
        subprocess.run(
            [sys.executable, "-m", "research.build_maternal_stallion_stage_stats", "--fetch-pedigree"],
            cwd=_ROOT,
            check=False,
        )
        subprocess.run(
            [
                sys.executable,
                "-m",
                "research.build_stallion_ancestor_graph",
                "--from-parquet",
