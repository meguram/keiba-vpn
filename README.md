...
├── config/               # 設定ファイル
├── docs/                 # ドキュメント
│   ├── ARCHITECTURE.md / DATASOURCES.md / cost.md
│   ├── modeling/              # 仕様書（設計の正）
│   └── html/                  # 参照用 HTML
├── tests/                # ユニットテスト
...
- [docs/DATASOURCES.md](docs/DATASOURCES.md) — データソース仕様
- [docs/modeling/](docs/modeling/) — モデリング・レーティング・データセット設計仕様
- [docs/cost.md](docs/cost.md) — GCS コスト分析
