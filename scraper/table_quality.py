...
Usage:
    # 品質チェックのみ
    python -m scraper.table_quality --years 2020,2021,2022,2023,2024,2025

    # チェック + 不合格テーブルの再作成
    python -m scraper.table_quality --years 2020,2021,2022,2023,2024,2025 --rebuild

    # 全テーブル強制再作成
    python -m scraper.table_quality --years 2020,2021,2022,2023,2024,2025 --rebuild --force
"""
...
def _schema_sample_check(
    ...
    from scraper.schemas import validate as validate_schema
    from scraper.export_tables import is_jra_race
...
def rebuild_failed_tables(
    ...
    *, force: bool = False, skip_schema: bool = False,
    ...
    """
    from scraper.storage import HybridStorage
    from scraper.export_tables import (
