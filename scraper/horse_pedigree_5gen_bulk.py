...
牡スロットは ``research.pedigree_similarity.is_male_pedigree_slot``（同一世代内で position が偶数）
...
from scraper.job_queue import PRIORITY_URGENT_PEDIGREE_5GEN, ScrapeJobQueue  # noqa: E402
