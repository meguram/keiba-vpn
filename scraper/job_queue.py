...
def _queue_stagger_delay_sec() -> float:
    ...
    from scraper.queue_load_settings import get_effective_stagger_sec
...
def _build_queue_eta(
    *,
    ...
    from scraper.queue_load_settings import get_effective_eta_sec_per_job
...
class ScrapeJobQueue:
    ...
    def _normalize_incoming_job(self, job: dict) -> dict[str, Any]:
        ...
        from scraper.scrape_policy import coerce_bool, resolve_enqueue_overwrite_smart_skip
    ...
    def _run_storage_precheck(self) -> dict[str, Any]:
        ...
        従来どおり batch キー照会を併用）。
        """
        from scraper.queue_storage_precheck import (
            apply_unified_storage_precheck_patches,
            plan_unified_storage_precheck,
        )
        from scraper.run import REPO_ROOT
    ...
    def clear_all_jobs_with_transport_pause(
        ...
        """
        from scraper.scrape_access_pause import clear_access_pause, write_access_pause
