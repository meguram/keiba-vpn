...
def execute_job(runner: Any, job: dict) -> None:
    ...
    from scraper.persist_context import reset_skip_local_mirror, set_skip_local_mirror
    from scraper.queue_job_progress import (
...
def _race_task(
    ...
    *,
    ...
    from scraper.queue_job_progress import get_current_job_id, update_job_progress
