...
MODEL_CATALOG: dict[str, ModelSpec] = {
    ...
    "lap_predictor": ModelSpec(
        key="lap_predictor",
        title="ラップ予測（LightGBM per-furlong）",
        description="T-11: 1F 毎ラップ秒数予測（LightGBM regression）",
        experiment_name="lap-prediction",
        registered_name="lap-predictor-lgbm",
        flavor=ModelFlavor.LIGHTGBM,
        lifecycle=ModelLifecycle.PLANNED,
        default_serve_port=5005,
        serve_uri_setting_key="serve_uri",
        legacy_serve_env_vars=("KEIBA_MLFLOW_SERVE_LAP_PREDICTOR_URI",),
        local_booster_relpaths=(),
    ),
    "lap_lstm": ModelSpec(
        key="lap_lstm",
        ...
        experiment_name="lap-prediction",
        registered_name="lap-predictor-lstm",
        flavor=ModelFlavor.SKLEARN,
        lifecycle=ModelLifecycle.PLANNED,
        default_serve_port=5006,
        serve_uri_setting_key="serve_uri",
        legacy_serve_env_vars=("KEIBA_MLFLOW_SERVE_LAP_LSTM_URI",),
        local_booster_relpaths=(),
    ),
}
