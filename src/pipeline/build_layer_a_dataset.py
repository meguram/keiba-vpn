...
LayerA 学習用 Parquet を生成する CLI。
  ...
  python3 -m src.pipeline.build_layer_a_dataset --years 2022,2023,2024
...
from src.pipeline.models.layer_a_dataset import (  # noqa: E402
    DEFAULT_META_JSON,
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        type=Path,
        default=None,
        help="research.race.tune_track_bias_weights の出力 JSON（指定時は --track-bias-*-weight より優先）",
    )
