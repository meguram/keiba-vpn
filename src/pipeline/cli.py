...
使い方:
  python -m src.pipeline.cli predict 20260315
  python -m src.pipeline.cli predict 20260315 --race-ids 202606010101,202606010102
  python -m src.pipeline.cli train
  python -m src.pipeline.cli train --features-dir data/features
"""
