...
使い方:
  cd keiba-vpn && python3 scripts/data/upload_cushion_values_to_gcs.py
  python3 scripts/data/upload_cushion_values_to_gcs.py --also-full
  python3 scripts/data/upload_cushion_values_to_gcs.py --dry-run
"""
...
from src.scraper.jra_cushion_storage import upload_cushion_values_to_gcs  # noqa: E402
