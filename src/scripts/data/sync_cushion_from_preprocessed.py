...
使い方:
  cd keiba-vpn && python3 scripts/data/sync_cushion_from_preprocessed.py --dry-run
  python3 scripts/data/sync_cushion_from_preprocessed.py --years 2026
  python3 scripts/data/sync_cushion_from_preprocessed.py --no-local-json
"""
...
from src.scraper.jra_cushion_sync import sync_preprocessed_to_jra_cushion  # noqa: E402
