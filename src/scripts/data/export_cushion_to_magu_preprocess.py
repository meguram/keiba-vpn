...
使い方:
  python3 scripts/data/export_cushion_to_magu_preprocess.py
  python3 scripts/data/export_cushion_to_magu_preprocess.py --skip-years ""
  MAGU_CUSHION_DATA_ROOT=/path/to/cushion_data python3 scripts/data/export_cushion_to_magu_preprocess.py
"""
