...
使い方:
  python scripts/scraping/fetch_race_calendar.py 2026-03-21
  python scripts/scraping/fetch_race_calendar.py 2026-03-21 2026-03-22
"""
...
from src.scraper.netkeiba_top_race_list import fetch_races_for_kaisai_date
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("使い方: python scripts/scraping/fetch_race_calendar.py 2026-03-21 [2026-03-22]")
        sys.exit(1)
