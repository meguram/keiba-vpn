...
Usage:
    ...
    PYTHONPATH=. python scripts/scraping/batch_scrape_2026.py
    PYTHONPATH=. python scripts/scraping/batch_scrape_2026.py --start-date 20260201
    PYTHONPATH=. python scripts/scraping/batch_scrape_2026.py --month 1          # 1月だけ
    PYTHONPATH=. python scripts/scraping/batch_scrape_2026.py --smart-skip       # 鮮度チェック有効

    # 旧モード (レース単位逐次)
    PYTHONPATH=. python scripts/scraping/batch_scrape_2026.py --legacy
"""
