...
Usage:
  cd keiba-vpn && python3 -m src.scripts.scraping.bump_queue_pending_mutable_refresh
  python3 -m src.scripts.scraping.bump_queue_pending_mutable_refresh --dry-run
"""
