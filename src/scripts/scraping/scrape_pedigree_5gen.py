...
Usage:
  python scripts/scraping/scrape_pedigree_5gen.py --phase 1
  python scripts/scraping/scrape_pedigree_5gen.py --phase 2
  python scripts/scraping/scrape_pedigree_5gen.py --phase all
  python scripts/scraping/scrape_pedigree_5gen.py --phase 1 --workers 3
"""
...
from src.research.pedigree.pedigree_similarity import parse_blood_table_5gen, parse_horse_sex_from_ped_html
