...
from src.research.pedigree.sire_aptitude_note import resolve_sire_name, vector_for_canonical
...
def _race_horse_display_map(storage: Any, race_id: str) -> dict[str, str]:
    """horse_id -> 「枠X Y番 馬名」"""
    from src.research.pedigree.note_aptitude_race_map import load_race_entries
