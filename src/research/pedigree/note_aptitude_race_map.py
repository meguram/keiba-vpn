...
from src.research.pedigree.note_aptitude_5gen import blended_note_for_race_horse
...
if __name__ == "__main__":
    ...
    for a in sys.argv[1:]:
        if a in ("--5gen", "--5g"):
            ...
            rid = a
    if not rid:
        print("使い方: python -m src.research.pedigree.note_aptitude_race_map <race_id> [--5gen]")
        sys.exit(1)
    st = HybridStorage()
