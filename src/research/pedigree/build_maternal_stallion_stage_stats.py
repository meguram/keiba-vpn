...
---
    ...
    python3 -m src.research.pedigree.build_maternal_stallion_stage_stats \\
    ...
    python3 -m src.research.pedigree.build_maternal_stallion_stage_stats --pedigree-gz-only
"""
...
from src.pipeline.features.track_bias_pedigree import stage_key, track_condition_bucket  # noqa: E402
from src.research.pedigree.pedigree_similarity import is_maternal_side  # noqa: E402
