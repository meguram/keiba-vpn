...
Usage:
    python -m src.scraper.schema_sampler --years 2024
    python -m src.scraper.schema_sampler --years 2022,2023,2024 --samples 3
    python -m src.scraper.schema_sampler --years 2024 --export-tables
"""
...
def main() -> int:
    ...
    if args.export_tables:
        ...
        from src.scraper.export_tables import export_year
        for year in years:
