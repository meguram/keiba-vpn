...
使用例::
  ...
  # 接続・ログインのスモーク（5 レース）
  python scripts/backfill_race_barometer_gcs.py --from-year 2023 --to-year 2025 --limit 5

  # 本番（全件・時間がかかる）
  python scripts/backfill_race_barometer_gcs.py --from-year 2023 --to-year 2026
"""
