...
Usage:
  python3 scripts/monkey_test_growth_curve.py
  python3 scripts/monkey_test_growth_curve.py --n 40 --base-url http://127.0.0.1:8000
  python3 scripts/monkey_test_growth_curve.py --use-testclient
"""
