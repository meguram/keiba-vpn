...
#
# Usage:
#   bash scripts/cron/setup_watchdog_cron.sh          # 設定追加
#   bash scripts/cron/setup_watchdog_cron.sh --remove  # 設定削除
# ================================================================
...
echo "  cron削除: bash ${PROJECT_DIR}/scripts/cron/setup_watchdog_cron.sh --remove"
