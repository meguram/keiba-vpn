...
`data/local/tables` の flat テーブルから、特徴量ストア向けに選別した列をブロック別に登録する。
  ...
  python -m pipeline.register_raw_table_features
  python -m pipeline.register_raw_table_features --years 2024 2025 --overwrite
...
from pipeline.id_value_policy import NETKEIBA_STRING_ID_COLUMNS, netkeiba_string_id_present, sanitize_netkeiba_string_id
from pipeline.race_index_speed_recent import expand_speed_recent_column
from pipeline.raw_table_features import (
    ALL_RAW_SPECS,
    INDEX_SPECS,
    PADDOCK_SPECS,
