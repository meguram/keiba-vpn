...
def fm_path_from_gp(generation: int, position: int) -> str:
    ...
    ``research.pedigree_similarity.is_paternal_side`` と同じ分割:
...
def iter_gen5_male_anchor_horse_ids(primary_rows: list[dict[str, Any]]) -> list[tuple[str, str]]:
    ...
    """
    from research.pedigree_similarity import is_male_pedigree_slot
...
def merge_primary_and_branches(
    ...
    *,
    ...
    """
    from pipeline.horse_entity_layout import is_male_pedigree_slot_upto
