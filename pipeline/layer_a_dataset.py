...
参照: docs/modeling/pre_race_feature_whitelist.md（BaselineV1）
"""
...
from pipeline.feature_builder import _drop_public_indicators
from pipeline.race_index_speed_recent import expand_speed_recent_in_dataframe
...
DEFAULT_OUTPUT_PARQUET = Path("data/modeling/layer_a_train.parquet")
DEFAULT_META_JSON = Path("data/modeling/layer_a_train.meta.json")
...
def build_layer_a_dataframe(
    *,
    ...
    if include_history_stats:
        from pipeline.historical_entity_stats import merge_history_into_layer_a
    ...
    if include_jockey_trainer_stats:
        from pipeline.jockey_trainer_stats import merge_jt_race_features_into_layer_a
