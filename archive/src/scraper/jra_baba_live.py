...
Usage:
  python -m src.scraper.jra_baba_live               # 最新データ取得 (1回)
  python -m src.scraper.jra_baba_live --watch       # スケジュール連動ポーリング (推奨)
  python -m src.scraper.jra_baba_live --check       # 更新チェックのみ
  python -m src.scraper.jra_baba_live --schedule    # 直近のポーリング予定を表示
"""
