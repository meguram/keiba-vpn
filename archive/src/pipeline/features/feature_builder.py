...
def _pedigree_features(entry: dict, profile: dict, distance: int = 0) -> dict:
    ...
    try:
        from src.research.genes.myostatin import get_lookup
        mstn = get_lookup()
    ...
    try:
        from src.research.pedigree.sire_aptitude_note import compute_note_aptitude_features
        ...
        try:
            from src.research.pedigree.sire_aptitude_note import zero_note_aptitude_features
