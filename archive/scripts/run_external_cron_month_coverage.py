...
Usage:
  cd keiba-vpn && python3 scripts/run_external_cron_month_coverage.py
  python3 scripts/run_external_cron_month_coverage.py --days-back 30 --days-ahead 14 --skip-eve-batch
"""
